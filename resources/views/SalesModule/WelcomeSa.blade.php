...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Sales</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Welcome</span>
						</div>
					</div>
				...
				<div class="row">
                    ...
                    <div class="card" style="width: 70rem;">
                        ...
                        <div class="card-body">
                          ...
                          <br>
                          <h1 class="card-text" style="text-align: center">Welcome to <font color="#faab0c">Chain Nest </font> Sales of Inventory Management System.</h1>

                          <br>
                          <br>
                          <h6 style="text-align: center">
                            We hope that the inventory system satisfies you, so if you would like
                            to subscribe with us in the sales module and would have a good experience, please don't be late and contact us
                          </h6>
