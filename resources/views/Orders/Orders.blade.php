                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                            data-toggle="modal" href="#exampleModal"> Add New Order</a>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            <thead>
                                <tr style="text-align: center" class="table-success">
                                    ...
                                    <th class="border-bottom-0">order_Num</th>
                                    <th class="border-bottom-0">Cust_name</th>
                                    <th class="border-bottom-0">Cust_location </th>

                                    <th class="border-bottom-0">Supp_Location</th>
                                    <th class="border-bottom-0">order_value</th>
                                    <th class="border-bottom-0">Expected_delivery</th>
