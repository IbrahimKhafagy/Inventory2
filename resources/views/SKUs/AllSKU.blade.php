									...
									<table id="example" class="table key-buttons text-md-nowrap">
										<thead>
											<tr class="table-success" style="text-align: center">
                                                ...
                                                <th class="border-bottom-0">ِAccount Manager</th>
										...
										<tbody>
											...
											<tr style="text-align: center">
                                                ...
                                                {{-- <td>{{$products->Skus}}</td>
                                                <td>{{$products->Chainnest_Price}}</td> --}}
												<td>{{$products->Skus ? $products->Skus->SKU : "empty"}}</td>
                                                <td>{{$products->Skus ? $products->Skus->Chainnest_Price : "empty"}}</td>-
                                                ...
                                                <td>
                                                 ...
                                                 <a type="btn" class="btn btn-warning" href="skuedit/{{$products->Skus ? $products->Skus->id : 0}}">Edit</a>
                                                </td>
											</tr>
                                            @endforeach
