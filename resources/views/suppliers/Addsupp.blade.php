        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">lists</h4><span class="text mt-1 tx-13 mr-2 mb-0">/
                    Suppliers</span><span class="text-muted mt-1 tx-13 mr-2 mb-0">/Add</span>
            </div>
        </div>
                    ...
                    <form action="{{ route('submit.customer') }}" method="post" autocomplete="off"
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Supplier_Name</label>
                                <input type="text" class="form-control" id="Supplier_Name" name="Supplier_Name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Supplier_Code</label>
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success"><a href="{{route('submit.supplier')}}">Confirm</a></button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"><a href="Supplier">Close</a></button>
                            </div>
                        </div>
